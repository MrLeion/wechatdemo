...
public class FriendRefreshView extends ViewGroup implements OnDetectScrollListener {
    ...
    private void initRainbowView() {
        ...
        mRainbowView.setImageResource(com.lqr.wechat.R.mipmap.rainbow_ic);
    ...
    private void initListView() {
        ...
        View mHeadViw = LayoutInflater.from(getContext()).inflate(com.lqr.wechat.R.layout.list_head_layout, null);
