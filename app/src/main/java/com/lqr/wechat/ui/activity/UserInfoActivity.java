...
public class UserInfoActivity extends BaseActivity {
    ...
    TextView mTvName;
    @BindView(com.lqr.wechat.R.id.ivGender)
    ImageView mIvGender;
    @BindView(com.lqr.wechat.R.id.tvAccount)
    TextView mTvAccount;
    @BindView(com.lqr.wechat.R.id.tvNickName)
    TextView mTvNickName;
    @BindView(com.lqr.wechat.R.id.tvArea)
    TextView mTvArea;
    @BindView(com.lqr.wechat.R.id.tvSignature)
    TextView mTvSignature;

    @BindView(com.lqr.wechat.R.id.oivAliasAndTag)
    OptionItemView mOivAliasAndTag;
    @BindView(com.lqr.wechat.R.id.llArea)
    LinearLayout mLlArea;
    @BindView(com.lqr.wechat.R.id.llSignature)
    LinearLayout mLlSignature;

    @BindView(com.lqr.wechat.R.id.btnCheat)
    Button mBtnCheat;
    @BindView(com.lqr.wechat.R.id.btnAddToContact)
    Button mBtnAddToContact;

    @BindView(com.lqr.wechat.R.id.rlMenu)
    RelativeLayout mRlMenu;
    @BindView(com.lqr.wechat.R.id.svMenu)
    ScrollView mSvMenu;
    @BindView(com.lqr.wechat.R.id.oivAlias)
    OptionItemView mOivAlias;
    @BindView(com.lqr.wechat.R.id.oivDelete)
    ...
    public void initData() {
        ...
        mTvAccount.setText(UIUtils.getString(com.lqr.wechat.R.string.my_chat_account, mUserInfo.getUserId()));
        ...
        if (mFriend == null) {//陌生人
            ...
            if (DBManager.getInstance().isMe(mFriend.getUserId())) {//我
                ...
                if (TextUtils.isEmpty(nickName)) {
                    ...
                    mTvNickName.setText(UIUtils.getString(com.lqr.wechat.R.string.nickname_colon, mFriend.getName()));
                }
            } else {//陌生人
                mBtnCheat.setVisibility(View.GONE);
                mBtnAddToContact.setVisibility(View.VISIBLE);
    ...
    public void initListener() {
        ...
        mOivDelete.setOnClickListener(v -> {
            hideMenu();
            showMaterialDialog(UIUtils.getString(com.lqr.wechat.R.string.delete_contact),
                    UIUtils.getString(com.lqr.wechat.R.string.delete_contact_content, mUserInfo.getName()),
                    UIUtils.getString(com.lqr.wechat.R.string.delete),
                    UIUtils.getString(com.lqr.wechat.R.string.cancel),
                    v1 -> ApiRetrofit.getInstance()
                            ...
                            .subscribe(deleteFriendResponse -> {
                                ...
                                if (deleteFriendResponse.getCode() == 200) {
                                    ...
                                    UIUtils.showToast(UIUtils.getString(com.lqr.wechat.R.string.delete_success));
                                    BroadcastManager.getInstance(UserInfoActivity.this).sendBroadcast(AppConst.UPDATE_FRIEND);
                                    finish();
                                } else {
                                    UIUtils.showToast(UIUtils.getString(com.lqr.wechat.R.string.delete_fail));
                                }
                            }, this::loadError)
    ...
    protected int provideContentViewId() {
        return com.lqr.wechat.R.layout.activity_user_info;
    }
}
