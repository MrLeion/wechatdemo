...
public class LoginActivity extends BaseActivity<ILoginAtView, LoginAtPresenter> implements ILoginAtView {
    ...
    @BindView(com.lqr.wechat.R.id.tvProblems)
    TextView mTvProblems;
    @BindView(com.lqr.wechat.R.id.btnLogin)
    Button mBtnLogin;
    @BindView(com.lqr.wechat.R.id.tvOtherLogin)
    ...
    protected int provideContentViewId() {
        return com.lqr.wechat.R.layout.activity_login;
    }
