...
public class NewFriendActivity extends BaseActivity<INewFriendAtView, NewFriendAtPresenter> implements INewFriendAtView {
    ...
    @BindView(com.lqr.wechat.R.id.llToolbarAddFriend)
    LinearLayout mLlToolbarAddFriend;
    @BindView(com.lqr.wechat.R.id.tvToolbarAddFriend)
    TextView mTvToolbarAddFriend;

    @BindView(com.lqr.wechat.R.id.llNoNewFriend)
    LinearLayout mLlNoNewFriend;
    @BindView(com.lqr.wechat.R.id.llHasNewFriend)
    LinearLayout mLlHasNewFriend;
    @BindView(com.lqr.wechat.R.id.rvNewFriend)
    LQRRecyclerView mRvNewFriend;

    @Override
    public void initView() {
        mLlToolbarAddFriend.setVisibility(View.VISIBLE);
        setToolbarTitle(UIUtils.getString(com.lqr.wechat.R.string.new_friend));
    }
    ...
    protected int provideContentViewId() {
        return com.lqr.wechat.R.layout.activity_new_friend;
    }
