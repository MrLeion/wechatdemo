...
public class RemoveGroupMemberActivity extends BaseActivity {
    ...
    @BindView(com.lqr.wechat.R.id.btnToolbarSend)
    Button mBtnToolbarSend;
    @BindView(com.lqr.wechat.R.id.rvMember)
    ...
    public void initView() {
        ...
        mBtnToolbarSend.setText(UIUtils.getString(com.lqr.wechat.R.string.delete));
        mBtnToolbarSend.setVisibility(View.VISIBLE);
        mBtnToolbarSend.setBackgroundResource(com.lqr.wechat.R.drawable.shape_btn_delete);
    ...
    private void setAdapter() {
        if (mAdapter == null) {
            mAdapter = new LQRAdapterForRecyclerView<GroupMember>(this, mData, com.lqr.wechat.R.layout.item_contact) {
                @Override
                public void convert(LQRViewHolderForRecyclerView helper, GroupMember item, int position) {
                    helper.setText(com.lqr.wechat.R.id.tvName, item.getName()).setViewVisibility(com.lqr.wechat.R.id.cb, View.VISIBLE);
                    ...
                    CheckBox cb = helper.getView(com.lqr.wechat.R.id.cb);
                    ...
                    cb.setOnClickListener(v -> {
                        ...
                        if (mSelectedData.size() > 0) {
                            ...
                            mBtnToolbarSend.setText(UIUtils.getString(com.lqr.wechat.R.string.delete) + "(" + mSelectedData.size() + ")");
                        } else {
                            mBtnToolbarSend.setEnabled(false);
                            mBtnToolbarSend.setText(UIUtils.getString(com.lqr.wechat.R.string.delete));
                        }
    ...
    protected int provideContentViewId() {
        return com.lqr.wechat.R.layout.activity_remove_group_member;
    }
