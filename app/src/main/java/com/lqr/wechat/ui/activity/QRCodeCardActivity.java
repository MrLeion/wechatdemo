...
public class QRCodeCardActivity extends BaseActivity {
    ...
    ImageView mIvHeader;
    @BindView(com.lqr.wechat.R.id.ngiv)
    LQRNineGridImageView mNgiv;
    @BindView(com.lqr.wechat.R.id.tvName)
    TextView mTvName;
    @BindView(com.lqr.wechat.R.id.ivCard)
    ImageView mIvCard;
    @BindView(com.lqr.wechat.R.id.tvTip)
    TextView mTvTip;
    ...
    public void initView() {
        mTvTip.setText(UIUtils.getString(com.lqr.wechat.R.string.qr_code_card_tip));
    }
    ...
    protected int provideContentViewId() {
        return com.lqr.wechat.R.layout.activity_qr_code_card;
    }
}
