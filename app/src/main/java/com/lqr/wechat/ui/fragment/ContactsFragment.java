...
public class ContactsFragment extends BaseFragment<IContactsFgView, ContactsFgPresenter> implements IContactsFgView {
    ...
    @BindView(com.lqr.wechat.R.id.rvContacts)
    LQRRecyclerView mRvContacts;
    @BindView(com.lqr.wechat.R.id.qib)
    QuickIndexBar   mQib;
    @BindView(com.lqr.wechat.R.id.tvLetter)
    TextView        mTvLetter;
    ...
    public void initView(View rootView) {
        mHeaderView = View.inflate(getActivity(), com.lqr.wechat.R.layout.header_rv_contacts, null);
        mTvNewFriendUnread = (TextView) mHeaderView.findViewById(com.lqr.wechat.R.id.tvNewFriendUnread);
    ...
    public void initListener() {
        mHeaderView.findViewById(com.lqr.wechat.R.id.llNewFriend).setOnClickListener(v -> {
        ...
        mHeaderView.findViewById(com.lqr.wechat.R.id.llGroup).setOnClickListener(v -> ((MainActivity) getActivity()).jumpToActivity(GroupListActivity.class));
    ...
    protected int provideContentViewId() {
        return com.lqr.wechat.R.layout.fragment_contacts;
    }
