...
public class MainActivity extends BaseActivity<IMainAtView, MainAtPresenter> implements ViewPager.OnPageChangeListener, IMainAtView {
    ...
    @BindView(com.lqr.wechat.R.id.ibAddMenu)
    ImageButton mIbAddMenu;
    @BindView(com.lqr.wechat.R.id.vpContent)
    ViewPager mVpContent;

    //底部
    @BindView(com.lqr.wechat.R.id.llMessage)
    LinearLayout mLlMessage;
    @BindView(com.lqr.wechat.R.id.tvMessageNormal)
    TextView mTvMessageNormal;
    @BindView(com.lqr.wechat.R.id.tvMessagePress)
    TextView mTvMessagePress;
    @BindView(com.lqr.wechat.R.id.tvMessageTextNormal)
    TextView mTvMessageTextNormal;
    @BindView(com.lqr.wechat.R.id.tvMessageTextPress)
    TextView mTvMessageTextPress;
    @BindView(com.lqr.wechat.R.id.tvMessageCount)
    public TextView mTvMessageCount;

    @BindView(com.lqr.wechat.R.id.llContacts)
    LinearLayout mLlContacts;
    @BindView(com.lqr.wechat.R.id.tvContactsNormal)
    TextView mTvContactsNormal;
    @BindView(com.lqr.wechat.R.id.tvContactsPress)
    TextView mTvContactsPress;
    @BindView(com.lqr.wechat.R.id.tvContactsTextNormal)
    TextView mTvContactsTextNormal;
    @BindView(com.lqr.wechat.R.id.tvContactsTextPress)
    TextView mTvContactsTextPress;
    @BindView(com.lqr.wechat.R.id.tvContactCount)
    public TextView mTvContactCount;
    @BindView(com.lqr.wechat.R.id.tvContactRedDot)
    public TextView mTvContactRedDot;

    @BindView(com.lqr.wechat.R.id.llDiscovery)
    LinearLayout mLlDiscovery;
    @BindView(com.lqr.wechat.R.id.tvDiscoveryNormal)
    TextView mTvDiscoveryNormal;
    @BindView(com.lqr.wechat.R.id.tvDiscoveryPress)
    TextView mTvDiscoveryPress;
    @BindView(com.lqr.wechat.R.id.tvDiscoveryTextNormal)
    TextView mTvDiscoveryTextNormal;
    @BindView(com.lqr.wechat.R.id.tvDiscoveryTextPress)
    TextView mTvDiscoveryTextPress;
    @BindView(com.lqr.wechat.R.id.tvDiscoveryCount)
    public TextView mTvDiscoveryCount;

    @BindView(com.lqr.wechat.R.id.llMe)
    LinearLayout mLlMe;
    @BindView(com.lqr.wechat.R.id.tvMeNormal)
    TextView mTvMeNormal;
    @BindView(com.lqr.wechat.R.id.tvMePress)
    TextView mTvMePress;
    @BindView(com.lqr.wechat.R.id.tvMeTextNormal)
    TextView mTvMeTextNormal;
    @BindView(com.lqr.wechat.R.id.tvMeTextPress)
    TextView mTvMeTextPress;
    @BindView(com.lqr.wechat.R.id.tvMeCount)
    ...
    public void initView() {
        setToolbarTitle(UIUtils.getString(com.lqr.wechat.R.string.app_name));
        mIbAddMenu.setVisibility(View.VISIBLE);

        //等待全局数据获取完毕
        showWaitingDialog(UIUtils.getString(com.lqr.wechat.R.string.please_wait));
    ...
    public void initListener() {
        mIbAddMenu.setOnClickListener(v -> {
            //显示或隐藏popupwindow
            View menuView = View.inflate(MainActivity.this, com.lqr.wechat.R.layout.menu_main, null);
            ...
            menuView.findViewById(com.lqr.wechat.R.id.tvCreateGroup).setOnClickListener(v1 -> {
                jumpToActivity(CreateGroupActivity.class);
                popupWindow.dismiss();
            });
            menuView.findViewById(com.lqr.wechat.R.id.tvHelpFeedback).setOnClickListener(v1 -> {
                jumpToWebViewActivity(AppConst.WeChatUrl.HELP_FEED_BACK);
                popupWindow.dismiss();
            });
            menuView.findViewById(com.lqr.wechat.R.id.tvAddFriend).setOnClickListener(v1 -> {
                jumpToActivity(AddFriendActivity.class);
                popupWindow.dismiss();
            });
            menuView.findViewById(com.lqr.wechat.R.id.tvScan).setOnClickListener(v1 -> {
    ...
    protected int provideContentViewId() {
        return com.lqr.wechat.R.layout.activity_main;
    }
