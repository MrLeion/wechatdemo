...
public class RegisterAtPresenter extends BasePresenter<IRegisterAtView> {
    ...
    public void sendCode() {
        ...
        if (TextUtils.isEmpty(phone)) {
            UIUtils.showToast(UIUtils.getString(com.lqr.wechat.R.string.phone_not_empty));
            return;
        }

        if (!RegularUtils.isMobile(phone)) {
            UIUtils.showToast(UIUtils.getString(com.lqr.wechat.R.string.phone_format_error));
            return;
        }

        mContext.showWaitingDialog(UIUtils.getString(com.lqr.wechat.R.string.please_wait));
        ApiRetrofit.getInstance().checkPhoneAvailable(AppConst.REGION, phone)
                ...
                .flatMap(new Func1<CheckPhoneResponse, Observable<SendCodeResponse>>() {
                    ...
                    public Observable<SendCodeResponse> call(CheckPhoneResponse checkPhoneResponse) {
                        ...
                        if (code == 200) {
                            ...
                            return Observable.error(new ServerException(UIUtils.getString(com.lqr.wechat.R.string.phone_not_available)));
                        }
                    }
                })
                ...
                .subscribe(sendCodeResponse -> {
                    ...
                    if (code == 200) {
                        ...
                        sendCodeError(new ServerException(UIUtils.getString(com.lqr.wechat.R.string.send_code_error)));
                    }
                }, this::sendCodeError);
    }
                ...
                .subscribe(time -> {
                    if (getView().getBtnSendCode() != null) {
                        if (time >= 0) {
                            ...
                            getView().getBtnSendCode().setText(UIUtils.getString(com.lqr.wechat.R.string.send_code_btn_normal_tip));
                        }
                    } else {
                        mTimer.cancel();
                    }
    ...
    public void register() {
        ...
        if (TextUtils.isEmpty(password)) {
            UIUtils.showToast(UIUtils.getString(com.lqr.wechat.R.string.password_not_empty));
            return;
        }
        if (TextUtils.isEmpty(nickName)) {
            UIUtils.showToast(UIUtils.getString(com.lqr.wechat.R.string.nickname_not_empty));
            return;
        }
        if (TextUtils.isEmpty(code)) {
            UIUtils.showToast(UIUtils.getString(com.lqr.wechat.R.string.vertify_code_not_empty));
            return;
        }
        ...
        ApiRetrofit.getInstance().verifyCode(AppConst.REGION, phone, code)
                .flatMap(new Func1<VerifyCodeResponse, Observable<RegisterResponse>>() {
                    ...
                    public Observable<RegisterResponse> call(VerifyCodeResponse verifyCodeResponse) {
                        ...
                        if (code == 200) {
                            ...
                            return Observable.error(new ServerException(UIUtils.getString(com.lqr.wechat.R.string.vertify_code_error) + code));
                        }
                    }
                })
                .flatMap(new Func1<RegisterResponse, Observable<LoginResponse>>() {
                    ...
                    public Observable<LoginResponse> call(RegisterResponse registerResponse) {
                        ...
                        if (code == 200) {
                            ...
                            return Observable.error(new ServerException(UIUtils.getString(com.lqr.wechat.R.string.register_error) + code));
                        }
                    }
                })
                .subscribeOn(Schedulers.io())
                ...
                .subscribe(loginResponse -> {
                    ...
                    if (responseCode == 200) {
                        ...
                        UIUtils.showToast(UIUtils.getString(com.lqr.wechat.R.string.login_error));
