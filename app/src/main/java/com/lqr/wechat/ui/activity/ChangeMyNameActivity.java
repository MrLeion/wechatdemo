...
public class ChangeMyNameActivity extends BaseActivity {
    ...
    @BindView(com.lqr.wechat.R.id.etName)
    EditText mEtName;

    @Override
    public void initView() {
        mBtnToolbarSend.setText(UIUtils.getString(com.lqr.wechat.R.string.save));
    ...
    protected int provideContentViewId() {
        return com.lqr.wechat.R.layout.activity_change_name;
    }
}
