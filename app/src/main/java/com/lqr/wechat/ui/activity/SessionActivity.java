...
public class SessionActivity extends BaseFragmentActivity<ISessionAtView, SessionAtPresenter> implements ISessionAtView, IEmotionSelectedListener, BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    @BindView(com.lqr.wechat.R.id.ibToolbarMore)
    ImageButton mIbToolbarMore;

    @BindView(com.lqr.wechat.R.id.llRoot)
    LinearLayout mLlRoot;
    @BindView(com.lqr.wechat.R.id.llContent)
    LinearLayout mLlContent;
    @BindView(com.lqr.wechat.R.id.refreshLayout)
    BGARefreshLayout mRefreshLayout;
    @BindView(com.lqr.wechat.R.id.rvMsg)
    LQRRecyclerView mRvMsg;

    @BindView(com.lqr.wechat.R.id.ivAudio)
    ImageView mIvAudio;
    @BindView(com.lqr.wechat.R.id.btnAudio)
    Button mBtnAudio;
    @BindView(com.lqr.wechat.R.id.etContent)
    EditText mEtContent;
    @BindView(com.lqr.wechat.R.id.ivEmo)
    ImageView mIvEmo;
    @BindView(com.lqr.wechat.R.id.ivMore)
    ImageView mIvMore;
    @BindView(com.lqr.wechat.R.id.btnSend)
    Button mBtnSend;

    @BindView(com.lqr.wechat.R.id.flEmotionView)
    FrameLayout mFlEmotionView;
    @BindView(com.lqr.wechat.R.id.elEmotion)
    EmotionLayout mElEmotion;
    @BindView(com.lqr.wechat.R.id.llMore)
    LinearLayout mLlMore;

    @BindView(com.lqr.wechat.R.id.rlAlbum)
    RelativeLayout mRlAlbum;
    @BindView(com.lqr.wechat.R.id.rlTakePhoto)
    RelativeLayout mRlTakePhoto;
    @BindView(com.lqr.wechat.R.id.rlLocation)
    RelativeLayout mRlLocation;
    @BindView(com.lqr.wechat.R.id.rlRedPacket)
    ...
    public void initView() {
        mIbToolbarMore.setImageResource(com.lqr.wechat.R.mipmap.ic_session_info);
    ...
    private void initAudioRecordManager() {
        ...
        AudioRecordManager.getInstance(this).setAudioRecordListener(new IAudioRecordListener() {
            ...
            public void initTipView() {
                View view = View.inflate(SessionActivity.this, com.lqr.wechat.R.layout.popup_audio_wi_vo, null);
                mStateIV = (ImageView) view.findViewById(com.lqr.wechat.R.id.rc_audio_state_image);
                mStateTV = (TextView) view.findViewById(com.lqr.wechat.R.id.rc_audio_state_text);
                mTimerTV = (TextView) view.findViewById(com.lqr.wechat.R.id.rc_audio_timer);
            ...
            public void setTimeoutTipView(int counter) {
                if (this.mRecordWindow != null) {
                    ...
                    this.mStateTV.setText(com.lqr.wechat.R.string.voice_rec);
                    this.mStateTV.setBackgroundResource(com.lqr.wechat.R.drawable.bg_voice_popup);
            ...
            public void setRecordingTipView() {
                if (this.mRecordWindow != null) {
                    ...
                    this.mStateIV.setImageResource(com.lqr.wechat.R.mipmap.ic_volume_1);
                    this.mStateTV.setVisibility(View.VISIBLE);
                    this.mStateTV.setText(com.lqr.wechat.R.string.voice_rec);
                    this.mStateTV.setBackgroundResource(com.lqr.wechat.R.drawable.bg_voice_popup);
            ...
            public void setAudioShortTipView() {
                if (this.mRecordWindow != null) {
                    mStateIV.setImageResource(com.lqr.wechat.R.mipmap.ic_volume_wraning);
                    mStateTV.setText(com.lqr.wechat.R.string.voice_short);
                }
            }
            ...
            public void setCancelTipView() {
                if (this.mRecordWindow != null) {
                    this.mTimerTV.setVisibility(View.GONE);
                    this.mStateIV.setVisibility(View.VISIBLE);
                    this.mStateIV.setImageResource(com.lqr.wechat.R.mipmap.ic_volume_cancel);
                    this.mStateTV.setVisibility(View.VISIBLE);
                    this.mStateTV.setText(com.lqr.wechat.R.string.voice_cancel);
                    this.mStateTV.setBackgroundResource(com.lqr.wechat.R.drawable.corner_voice_style);
                }
            }
            ...
            public void onAudioDBChanged(int db) {
                switch (db / 5) {
                    case 0:
                        ...
                        break;
                    case 1:
                        this.mStateIV.setImageResource(com.lqr.wechat.R.mipmap.ic_volume_2);
                        break;
                    case 2:
                        this.mStateIV.setImageResource(com.lqr.wechat.R.mipmap.ic_volume_3);
                        break;
                    case 3:
                        this.mStateIV.setImageResource(com.lqr.wechat.R.mipmap.ic_volume_4);
                        break;
                    case 4:
                        this.mStateIV.setImageResource(com.lqr.wechat.R.mipmap.ic_volume_5);
                        break;
                    case 5:
                        this.mStateIV.setImageResource(com.lqr.wechat.R.mipmap.ic_volume_6);
                        break;
                    case 6:
                        this.mStateIV.setImageResource(com.lqr.wechat.R.mipmap.ic_volume_7);
                        break;
                    default:
                        this.mStateIV.setImageResource(com.lqr.wechat.R.mipmap.ic_volume_8);
                }
            }
        });
    }
...
//                        setToolbarSubTitle(UIUtils.getString(R.string.SET_TEXT_TYPING_TITLE));
                        setToolbarTitle(UIUtils.getString(com.lqr.wechat.R.string.SET_TEXT_TYPING_TITLE));
                    } else if (objectName.equals(voiceTag.value())) {
                        //显示“对方正在讲话”
//                        setToolbarSubTitle(UIUtils.getString(R.string.SET_VOICE_TYPING_TITLE));
                        setToolbarTitle(UIUtils.getString(com.lqr.wechat.R.string.SET_VOICE_TYPING_TITLE));
                    }
                } else {
...
//                    setToolbarSubTitle("");
    ...
    private void initEmotionKeyboard() {
        ...
        mEmotionKeyboard.setOnEmotionButtonOnClickListener(view -> {
            switch (view.getId()) {
                case com.lqr.wechat.R.id.ivEmo:
                    UIUtils.postTaskDelay(() -> mRvMsg.smoothMoveToPosition(mRvMsg.getAdapter().getItemCount() - 1), 50);
                    mEtContent.clearFocus();
                    if (!mElEmotion.isShown()) {
                        ...
                        mIvEmo.setImageResource(com.lqr.wechat.R.mipmap.ic_cheat_emo);
                        return false;
                    }
                    showEmotionLayout();
                    hideMoreLayout();
                    hideAudioButton();
                    break;
                case com.lqr.wechat.R.id.ivMore:
                    UIUtils.postTaskDelay(() -> mRvMsg.smoothMoveToPosition(mRvMsg.getAdapter().getItemCount() - 1), 50);
                    mEtContent.clearFocus();
                    if (!mLlMore.isShown()) {
                        if (mElEmotion.isShown()) {
    ...
    private void showAudioButton() {
        ...
        mIvAudio.setImageResource(com.lqr.wechat.R.mipmap.ic_cheat_keyboard);
    ...
    private void hideAudioButton() {
        ...
        mIvAudio.setImageResource(com.lqr.wechat.R.mipmap.ic_cheat_voice);
    }

    private void showEmotionLayout() {
        mElEmotion.setVisibility(View.VISIBLE);
        mIvEmo.setImageResource(com.lqr.wechat.R.mipmap.ic_cheat_keyboard);
    }
    ...
    protected int provideContentViewId() {
        return com.lqr.wechat.R.layout.activity_session;
    }
