...
public class SplashActivity extends BaseActivity {
    ...
    @BindView(com.lqr.wechat.R.id.rlButton)
    ...
    public void initView() {
        ...
        StatusBarUtil.setColor(this, UIUtils.getColor(com.lqr.wechat.R.color.black));
    ...
    protected int provideContentViewId() {
        return com.lqr.wechat.R.layout.activity_splash;
    }
}
