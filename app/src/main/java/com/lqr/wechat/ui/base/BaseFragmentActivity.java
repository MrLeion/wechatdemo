...
public abstract class BaseFragmentActivity<V, T extends BaseFragmentPresenter<V>> extends FragmentActivity {
    ...
    @BindView(com.lqr.wechat.R.id.appBar)
    protected AppBarLayout mAppBar;
    //    @BindView(R.id.toolbar)
    //    protected Toolbar mToolbar;
    @BindView(com.lqr.wechat.R.id.flToolbar)
    public FrameLayout mToolbar;
    @BindView(com.lqr.wechat.R.id.ivToolbarNavigation)
    public ImageView mToolbarNavigation;
    @BindView(com.lqr.wechat.R.id.vToolbarDivision)
    public View mToolbarDivision;
    @BindView(com.lqr.wechat.R.id.llToolbarTitle)
    public AutoLinearLayout mLlToolbarTitle;
    @BindView(com.lqr.wechat.R.id.tvToolbarTitle)
    public TextView mToolbarTitle;
    @BindView(com.lqr.wechat.R.id.tvToolbarSubTitle)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //沉浸式状态栏
        StatusBarUtil.setColor(this, UIUtils.getColor(com.lqr.wechat.R.color.colorPrimaryDark), 10);
...
//        }
    ...
    public Dialog showWaitingDialog(String tip) {
        hideWaitingDialog();
        View view = View.inflate(this, com.lqr.wechat.R.layout.dialog_waiting, null);
        if (!TextUtils.isEmpty(tip))
            ((TextView) view.findViewById(com.lqr.wechat.R.id.tvTip)).setText(tip);
        mDialogWaiting = new CustomDialog(this, view, com.lqr.wechat.R.style.MyDialog);
        mDialogWaiting.show();
